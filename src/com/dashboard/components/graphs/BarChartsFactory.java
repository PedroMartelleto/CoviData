...
public class BarChartsFactory {
	...
	public static BarChart<String, Number> deathsPerDay(String city) {
		BarChart<String, Number> barChart = barChart("Ã“bitos de COVID-19 por data de notificaÃ§Ã£o", "Data de NotificaÃ§Ã£o", "Ã“bitos");
		...
		series.setName("Ã“bitos por dia em " + city);
